...
const CONTACT_RECIPIENT_EMAIL = "contato@seudominio.com";
const REVIEWS_LINK = "#depoimentos";
...
const differentials = [
  { icon: HandshakeIcon, title: "Atendimento Personalizado", desc: "Consultoria direta com o(a) advogado(a) responsável." },
  { icon: Clock, title: "Análise do CNIS", desc: "Análise detalhada do CNIS e histórico contributivo." },
  { icon: Award, title: "Experiência Comprovada", desc: "Experiência de mais de 30 anos como advocacia" },
...
const testimonials = [
  {
    id: "cliente-um",
    name: "Cliente Modelo",
    role: "Avaliacao institucional",
    rating: 5,
    quote:
      "Atendimento tecnico, claro e cuidadoso desde o primeiro contato. Recebi orientacao objetiva e acompanhamento proximo em todas as etapas.",
  },
  {
    id: "cliente-dois",
    ...
    rating: 5,
    quote:
      "Profissionalismo, organizacao e comunicacao transparente. O escritorio conduziu meu caso com seguranca e atencao aos detalhes.",
  },
  {
    id: "cliente-tres",
    ...
    rating: 5,
    quote:
      "Fui muito bem orientado sobre meus direitos e os proximos passos. Recomendo o atendimento pela seriedade e dedicacao.",
  },
  {
    id: "cliente-quatro",
    ...
    rating: 5,
    quote:
      "A experiencia foi excelente. O atendimento foi humano, eficiente e sempre focado em encontrar a melhor solucao juridica.",
  },
];
        ...
        <div className="container mx-auto flex h-20 items-center justify-between">
          <a href="#" className="flex items-center gap-3">
            ...
            <span className="hidden sm:flex flex-col leading-tight">
              <span className="font-serif text-4xl font-bold text-primary">Nome Sobrenome </span>
        ...
        <div className="container mx-auto grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
          ...
          <div className="order-1 lg:order-2">
            ...
            <p className="mt-6 text-muted-foreground leading-relaxed">
              A Advocacia Modelo é um escritório dedicado à excelência técnica e ao
            ...
            <p className="mt-4 text-muted-foreground leading-relaxed">
              Atendimento presencial em endereco a definir;<br />
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-start">
            <div className="lg:sticky lg:top-32">
              ...
              <p className="mt-6 text-muted-foreground leading-relaxed">
                ...
                diferenciais que tornam a Advocacia Modelo a escolha certa para a
                sua causa.
              </p>
          ...
          <div className="mt-16 grid lg:grid-cols-5 gap-8">
            ...
            <div className="lg:col-span-2 space-y-4">
              ...
              {[
                ...
                { icon: Mail, label: "Email", value: "contato@seudominio.com" },
                {
  icon: MapPin,
  label: "Endereço",
  value: (
    <span translate="no">
      Rua Exemplo, 000 - Bairro - Cidade/UF
    </span>
  )
},
        ...
        <div className="container mx-auto py-16">
          <div className="grid md:grid-cols-4 gap-10">
            <div className="md:col-span-2">
              <div className="flex items-center gap-3">
                <img src={logo} alt="Logotipo do escritorio" className="h-12 w-auto brightness-0 invert" />
                <div className="font-serif text-xl text-white">Advocacia Modelo</div>
              </div>
            ...
            <div>
              ...
              <ul className="mt-5 space-y-3 text-sm text-white/60">
                ...
                <li className="pt-3 text-white/40 text-xs">OAB/UF 000.000</li>
              </ul> 
            </div>
          </div>
          ...
          <div className="mt-14 pt-8 border-t border-white/10 flex flex-col sm:flex-row items-center justify-between gap-4 text-xs text-white/50">
            <div>© {new Date().getFullYear()} Advocacia Modelo. Todos os direitos reservados.</div>
